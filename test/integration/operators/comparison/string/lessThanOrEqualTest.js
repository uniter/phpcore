...
describe('PHP string less-than-or-equal comparison operator "<=" integration', function () {
...
*/;}), //jshint ignore:line
        ...
        expect((await engine.execute()).getNative()).to.deep.equal({
            'int string <= smaller int': false,
            'int string <= same int': true,
            'int string <= larger int': true,

            'float string <= smaller float': false,
            'float string <= same float': true,
            'float string <= larger float': true,

            'int string <= smaller float': false,
            'int string <= same float': true,
            'int string <= larger float': true,

            'float string <= smaller int': false,
            'float string <= same int': true,
            'float string <= larger int': true
        });
    });
});
