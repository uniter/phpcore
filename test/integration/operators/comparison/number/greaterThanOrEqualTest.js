...
describe('PHP number greater-than-or-equal comparison operator ">=" integration', function () {
...
*/;}), //jshint ignore:line
        ...
        expect((await engine.execute()).getNative()).to.deep.equal({
            ...
            'int >= smaller float': true, // Greater-than-or-equal comparison is done loosely.
            'int >= same float': true,
