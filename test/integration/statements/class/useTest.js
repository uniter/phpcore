...
describe('PHP class use trait statement integration', function () {
    it('should support using multiple traits in one class via one use statement', async function () {
...
*/;}),//jshint ignore:line
    ...
    it('should support using multiple traits in one class via separate use statements', async function () {
        var php = nowdoc(function () {/*<<<EOS
<?php
