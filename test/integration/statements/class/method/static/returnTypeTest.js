...
describe('PHP class static method return type integration', function () {
    it('should be able to return from a method with correct type in weak type-checking mode', async function () {
        var php = nowdoc(function () {/*<<<EOS
<?php

class MyClass {
    public static function getNumber($myValue) : int {
        return $myValue;
    }
}
...
$result['int'] = MyClass::getNumber(21);
...
$result['fully numeric string'] = tryCall(function () {
    return MyClass::getNumber('21');
});
$result['leading numeric string'] = tryCall(function () {
    return MyClass::getNumber('21abc');
});
