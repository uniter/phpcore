...
describe('PHP nullable "?" type integration', function () {
    var doRun,
        outputLog;
...
*/;}), //jshint ignore:line
    ...
    it('should allow passing null for function parameters typed as "?array"', async function () {
        var php = nowdoc(function () {/*<<<EOS
<?php
...
*/;}), //jshint ignore:line
    ...
    it('should raise an error when a "?array"-type parameter is given an invalid argument', async function () {
        var php = nowdoc(function () {/*<<<EOS
<?php
...
// Strings are not valid arrays or null.
