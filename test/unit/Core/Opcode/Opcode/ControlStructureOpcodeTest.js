...
var expect = require('chai').expect,
    sinon = require('sinon'),
    ControlStructureOpcode = require('../../../../../src/Core/Opcode/Opcode/ControlStructureOpcode'),
    Trace = require('../../../../../src/Control/Trace');

describe('ControlStructureOpcode', function () {
    var handler,
        opcode,
        trace;
    ...
    beforeEach(function () {
        ...
        opcode = new ControlStructureOpcode(trace, 21, handler, ['first arg', 'second arg']);
    });
