...
var expect = require('chai').expect,
    ...
    SlotType = require('../../../../../src/Core/Opcode/Type/SlotType'),
    Value = require('../../../../../src/Value').sync(),
    ValueFactory = require('../../../../../src/ValueFactory').sync(),
    Variable = require('../../../../../src/Variable').sync();

describe('Opcode SlotType', function () {
    var type,
        valueFactory;
    ...
    beforeEach(function () {
        ...
        type = new SlotType(valueFactory);
    });
    ...
    describe('coerceValue()', function () {
        ...
        it('should throw when given a ReferenceElement instance', function () {
            ...
            expect(function () {
                ...
                Exception,
                'Unexpected value provided for SlotType'
            );
        });
    ...
    describe('getDisplayName()', function () {
        it('should return "slot"', function () {
            expect(type.getDisplayName()).to.equal('slot');
        });
    });
});
