...
module.exports = {
    'en_GB': {
        'core': {
            ...
            'cannot_assign_incompatible_property_type': 'Cannot assign ${actualType} to property ${className}::$${propertyName} of type ${expectedType}',
            'cannot_assign_incompatible_reference_type': 'Cannot assign ${actualType} to reference held by property ${className}::$${propertyName} of type ${expectedType}',
            'error_in_file': ' in ${filePath}:${lineNumber}',
            'cannot_indirectly_modify_readonly_property': 'Cannot indirectly modify readonly property ${className}::$${propertyName}',
            'cannot_modify_readonly_property': 'Cannot modify readonly property ${className}::$${propertyName}',
