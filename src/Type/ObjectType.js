...
/**
 * Represents a type that can only accept an object value.
 *
 * @param {FutureFactory} futureFactory
 * @param {boolean} nullIsAllowed
 * @constructor
 */
function ObjectType(futureFactory, nullIsAllowed) {
    /**
     * @type {FutureFactory}
     */
...
util.inherits(ObjectType, TypeInterface);

_.extend(ObjectType.prototype, {
    /**
     * {@inheritdoc}
     */
    allowsNull: function () {
